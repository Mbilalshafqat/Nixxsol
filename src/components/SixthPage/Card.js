...
<div className="card mb-3 no-hover" style={{ border:"none"}}>
  <div className="row custom-row g-0">
    ...
    <div className="col-md-4">
      <img src="./Sixth-page/image1.png" className="img-fluid rounded-start" alt="..."/>
    </div>
  </div>
</div>
...
<div className="card mb-3 no-hover" style={{border:"none"}}>
  <div className="row g-0">
    <div className="col-md-4 order-2 order-md-1">
      <img src="./Sixth-page/image2.png" className="img-fluid rounded-start" alt="..."/>
    </div>
...
<div className="card mb-3 no-hover" style={{border:"none"}}>
  <div className="row g-0">
    ...
    <div className="col-md-4">
      <img src="./Sixth-page/image3.png" className="img-fluid rounded-start" alt="..."/>
    </div>
  </div>
</div>
